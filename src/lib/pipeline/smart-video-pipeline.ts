 ...
 * Processes product images through the full pipeline:
 * Vision analysis -> Asset matching -> Prompt orchestration -> Scene generation -> Video assembly
 */

import { analyzeProductImage } from "../ai/vision-analyzer";
import { orchestratePrompts } from "../ai/prompt-orchestrator";
import { generateScene, pollSceneStatus } from "../video/scene-generator";
import { assembleVideo, pollAssemblyStatus } from "../video/video-assembler";
import { matchProductAssets } from "../video/asset-matcher";
import type { ProductTruth, MarketInsight } from "../types";
